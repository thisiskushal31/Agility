      ...
      <div class="footer__main">
        <div class="footer__logo">
          <a href="#" class="footer__brand">
            <img src={logo} alt="" class="footer__brand--img"/>
          </a>
        </div>
        ...
        <nav class="footer__navigation">
          <ul class="footer__menu">
            ...
            <li class="footer__menu--list">
              <a href="#" class="footer__menu--link">Pricing</a>
            </li>
            <li class="footer__menu--list">
          ...
          <ul class="footer__nav">
            ...
            <li class="footer__nav--list">
              <a href="#" class="footer__nav--link">Community</a>
            </li>
            <li class="footer__nav--list">
        ...
        <form action="" class="footer__form">
          <div class="footer__form--Item" id="inputBox">
            <input id="email" type="email" class="footer__form--input" placeholder="Updates in your inbox..."/>
            <i class="fa-solid fa-check footer__form--Item-check"></i>
            <i class="fa-solid fa-xmark footer__form--Item-wrong"></i>
          </div>
          <div class="footer__form--Item">
            <button class="footer__form--btn" type="submit">Go</button>
          </div>
        </form>
        <div class="footer__credits">
          <p class="footer__credits--paragraph">
