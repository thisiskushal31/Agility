      ...
      <div className="footer__main">
        <div className="footer__logo">
          <Link to="#" className="footer__brand">
            <img src={logo} alt="" className="footer__brand--img"/>
          </Link>
        </div>
        <div className="footer__socialnetwork">
          <Link to="#" className="footer__socialnetwork--sc">
        ...
        <nav className="footer__navigation">
          <ul className="footer__menu">
            ...
            <li className="footer__menu--list">
              <Link to="#" className="footer__menu--link">Pricing</Link>
            </li>
            <li className="footer__menu--list">
              <Link to="#" className="footer__menu--link">Products</Link>
            </li>
            <li className="footer__menu--list">
              <Link to="#" className="footer__menu--link">About Us</Link>
            </li>
          </ul>
          <ul className="footer__nav">
            ...
            <li className="footer__nav--list">
              <Link to="#" className="footer__nav--link">Community</Link>
            </li>
            <li className="footer__nav--list">
              <Link to="#" className="footer__nav--link">Privacy Policy</Link>
            </li>
          </ul>
        </nav>
        <form action="" className="footer__form">
          <div className="footer__form--Item" id="inputBox">
            <input id="email" type="email" className="footer__form--input" placeholder="Updates in your inbox..."/>
          </div>
          <div className="footer__form--Item">
            <button className="footer__form--btn" type="submit">Go</button>
          </div>
        </form>
